...
const _assets = {
  ["nitro:bundled:cache:content:content-index.json"]: {
    ...
    meta: {"type":"application/json","etag":"\"2b-bPFOhmYMEZGApLcEMf37eUklfUQ\"","mtime":"2025-07-22T09:52:54.759Z"}
  },
  ["nitro:bundled:cache:content:content-navigation.json"]: {
    import: () => import('../raw/content-navigation.mjs').then(r => r.default || r),
    meta: {"type":"application/json","etag":"\"80-/vrycMGchvPZrBsibKJS8PBZV4c\"","mtime":"2025-07-22T09:52:54.759Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:quick-start.md"]: {
    import: () => import('../raw/quick-start.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"cf1a-E71zykQjBDjNvBM8RBbcK2FZBOQ\"","mtime":"2025-07-22T09:52:54.762Z"}
  }
};
...
function defineCachedFunction(fn, opts = {}) {
  ...
  const integrity = opts.integrity || hash$2([fn, opts]);
...
function getKey(...args) {
  return args.length > 0 ? hash$2(args) : "";
}
...
function defineCachedEventHandler(handler, opts = defaultCacheOptions()) {
  ...
  const _opts = {
    ...
    getKey: async (event) => {
      ...
      const _hashedPath = `${_pathname}.${hash$2(_path)}`;
      const _headers = variableHeaderNames.map((header) => [header, event.node.req.headers[header]]).map(([name, value]) => `${escapeKey(name)}.${hash$2(value)}`);
    ...
    integrity: opts.integrity || hash$2([handler, opts])
  };
  const _cachedHandler = cachedFunction(
    async (incomingEvent) => {
      ...
      headers.etag = String(
        headers.Etag || headers.etag || `W/"${hash$2(body)}"`
      );
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "e4407386-46bb-4005-bbff-afb76df670d4",
  ...
  "public": {
    "apiBase": "https://testapi.incustom.com",
  ...
  "content": {
    ...
    "sources": {
      "content": {
        "driver": "fs",
        "base": "D:/gitstore/testincustom/app/content"
      }
    },
    "ignores": [],
    "locales": [],
...
const _e2BFy3CSjYO6jQ5cY0cmYfGTv61xa4f5hWZsrbCvC4E = defineNitroPlugin(async nitroApp => {
...
const _xMKqF7zzGo3Ftz8QmYo9ZDICZyiN8JVgr5KTwftGGP0 = defineNitroPlugin(async (nitroApp) => {
...
const _2NU9LGdUeuD9fKSZvyvm50JOFS4df6Hu_pQdQAsL8M = defineNitroPlugin(async (nitroApp) => {
...
const _lBr8bLNHdq2BBkvtUDNxlMwstpBSViSFtwDng65MM = defineNitroPlugin((nitroApp) => {
...
const __BplX1ICWVbkVX3a3pOyM8AzMIXhvv2Yq_lRUsuiFDA = defineNitroPlugin((nitroApp) => {
...
const _pzxbUdkBEIpdcOw6kpPKHDWKm63vgyXbwkaBF1bt2vY = (function(nitro) {
...
const plugins = [
  _e2BFy3CSjYO6jQ5cY0cmYfGTv61xa4f5hWZsrbCvC4E,
_xMKqF7zzGo3Ftz8QmYo9ZDICZyiN8JVgr5KTwftGGP0,
_2NU9LGdUeuD9fKSZvyvm50JOFS4df6Hu_pQdQAsL8M,
_lBr8bLNHdq2BBkvtUDNxlMwstpBSViSFtwDng65MM,
__BplX1ICWVbkVX3a3pOyM8AzMIXhvv2Yq_lRUsuiFDA,
_pzxbUdkBEIpdcOw6kpPKHDWKm63vgyXbwkaBF1bt2vY
];

const _bowsuT = eventHandler(async (event) => {
...
const _2RhQrz = defineEventHandler(async (e) => {
...
const _ZZ_lUr = defineEventHandler(async (e) => {
...
const _iHx0c_ = defineEventHandler(async (e) => {
...
const _5MKyk4 = defineEventHandler(async (e) => {
  const content = [];
  try {
...
const _Z_Gi0w = defineEventHandler(async (e) => {
...
const collections = {
  'heroicons': () => import('./heroicons.mjs').then(m => m.default),
};

const DEFAULT_ENDPOINT = "https://api.iconify.design";
const _1XgVEE = defineCachedEventHandler(async (event) => {
...
const appHead = {"link":[{"rel":"icon","href":"/favicon-16x16.png","type":"image/png","sizes":"300x300"},{"rel":"icon","href":"/favicon-32x32.png","type":"image/png","sizes":"300x300"},{"rel":"icon","href":"/favicon-32x321.png","type":"image/png","sizes":"32x32"},{"rel":"icon","href":"/favicon.svg","type":"image/svg+xml","sizes":"any"},{"rel":"icon","href":"/icon.svg","type":"image/svg+xml","sizes":"any"},{"rel":"icon","href":"/officon.png","type":"image/png","sizes":"148x148"},{"rel":"apple-touch-icon","href":"/apple-touch-icon.png","type":"image/png","sizes":"180x180"}],"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"property":"og:image","content":"og-image.jpg"},{"property":"og:image:type","content":"image/jpeg"},{"property":"og:image:width","content":"1150"},{"property":"og:image:height","content":"846"},{"name":"twitter:image","content":"og-image.jpg"},{"name":"twitter:image:type","content":"image/jpeg"},{"name":"twitter:image:width","content":"1150"},{"name":"twitter:image:height","content":"846"},{"property":"og:type","content":"website"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{}};
...
const _XLeRaX = defineEventHandler(async (event) => {
...
const _JEeiX3 = defineEventHandler(async (event) => {
...
const _IOxKT9 = defineEventHandler(async (event) => {
  const { getContentQuery } = await import('./query.mjs');
  const { cacheStorage, serverQueryContent } = await Promise.resolve().then(function () { return storage; });
...
const _MSOHMR = lazyEventHandler(() => {
...
const _lazy_mDliH0 = () => import('../routes/api/store/external-data/_id_.mjs');
const _lazy_hq9W9R = () => import('../routes/api/store/index.mjs');
const _lazy_APOjoU = () => import('../routes/api/store/local-data/_id_.mjs');
const _lazy_HUAMUn = () => import('../routes/api/store/local-data/data.mjs');
const _lazy_xTpqlm = () => import('../routes/api/store/index2.mjs');
const _lazy_SkhQaK = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '/api/store/external-data/:id', handler: _lazy_mDliH0, lazy: true, middleware: false, method: undefined },
  { route: '/api/store/external-data', handler: _lazy_hq9W9R, lazy: true, middleware: false, method: undefined },
  { route: '/api/store/local-data/:id', handler: _lazy_APOjoU, lazy: true, middleware: false, method: undefined },
  { route: '/api/store/local-data/data', handler: _lazy_HUAMUn, lazy: true, middleware: false, method: undefined },
  { route: '/api/store/local-data', handler: _lazy_xTpqlm, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_SkhQaK, lazy: true, middleware: false, method: undefined },
  { route: '/api/_mdc/highlight', handler: _bowsuT, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _2RhQrz, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _ZZ_lUr, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _iHx0c_, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/nuxt-content.json', handler: _5MKyk4, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/nuxt-content-urls.json', handler: _WBjrtq, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _qoB4fX, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _Z_Gi0w, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _1XgVEE, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _XLeRaX, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _XLeRaX, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _XLeRaX, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.1753177808618.json', handler: _JEeiX3, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _IOxKT9, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _IOxKT9, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _IOxKT9, lazy: false, middleware: false, method: "get" },
  { route: '/_ipx/**', handler: _MSOHMR, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_SkhQaK, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, defu as A, createDefu as B, hasProtocol as C, isScriptProtocol as D, joinURL as E, useHead as F, useServerHead as G, withQuery as H, sanitizeStatusCode as I, getRequestHeader as J, withTrailingSlash as K, withoutTrailingSlash as L, isEqual as M, getContext as N, setCookie as O, getCookie as P, deleteCookie as Q, diff as R, baseURL as S, createHooks as T, executeAsync as U, toRouteMatcher as V, createRouter$1 as W, camelCase as X, getRequestHeaders as Y, stringifyQuery as Z, parseURL as _, getResponseStatus as a, withLeadingSlash as a0, withBase as a1, useSeoMeta as a2, rehypeHighlight as a3, encodeParam as a4, encodePath as a5, upperFirst as a6, hash$1 as a7, pascalCase as a8, kebabCase as a9, prefixStorage as aa, createStorage as ab, memoryDriver as ac, appId as b, createError$1 as c, defineEventHandler as d, defineRenderHandler as e, buildAssetsURL as f, getResponseStatusText as g, publicAssetsURL as h, appTeleportTag as i, appTeleportAttrs as j, getQuery as k, createSSRContext as l, appHead as m, destr as n, getRouteRules as o, parseQuery as p, getRenderer as q, replaceIslandTeleports as r, setSSRError as s, toNodeListener as t, useNitroApp as u, useRuntimeConfig as v, generateTitle as w, defuFn as x, klona as y, headSymbol as z };
