...
import { a0 as withLeadingSlash, K as withTrailingSlash, E as joinURL } from '../_/nitro.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(__nuxt_component_0)), mergeProps({
