import { a1 as withBase, a0 as withLeadingSlash, E as joinURL, L as withoutTrailingSlash, a7 as hash } from '../_/nitro.mjs';
import { w as useRuntimeConfig, Q as useRequestEvent } from './server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-D948hoRp.mjs').then((m) => m.useContentDatabase());
