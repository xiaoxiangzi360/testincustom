...
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-B8ZgYaGI.mjs';
import { u as useContentPreview } from './preview-CktqsZ1v.mjs';
import { I as useState, a as __nuxt_component_1$2, w as useRuntimeConfig } from './server.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-D948hoRp.mjs').then((m) => m.generateNavigation);
...
const ContentNavigation = defineComponent({
  ...
  render(ctx) {
    ...
    const renderLink = (link) => h(__nuxt_component_1$2, { to: link._path }, () => link.title);
