import { _ as _export_sfc, e as __nuxt_component_7, c as __nuxt_component_5, m as mergeConfig, U as UIcon, i as useUI, s as omit$1, j as appConfig, v as button } from './server.mjs';
import { mergeProps, withCtx, createVNode, toDisplayString, defineComponent, resolveComponent, unref, renderSlot, createTextVNode, withKeys, Transition, createBlock, withDirectives, openBlock, vShow, toRef, computed, ref, watch, useId, onMounted, onUnmounted, provide, watchEffect, inject, useSSRContext } from 'vue';
...
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderSlot, ssrRenderStyle } from 'vue/server-renderer';
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender]]), { __name: "UAccordion" });
const _sfc_main = {
  __name: "Faq",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UButton = __nuxt_component_7;
      const _component_UIcon = __nuxt_component_5;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full" }, _attrs))} data-v-07fae315><div class="max-row py-10" data-v-07fae315><h1 class="text-3xl md:text-5xl text-blackcolor font-normal text-center mb-12 dark:text-white" data-v-07fae315> FAQ </h1>`);
      _push(ssrRenderComponent(_component_UAccordion, {
        ...
        default: withCtx(({ item, index, open }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UButton, {
              ...
              default: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="truncate text-blackcolor text-left dark:text-white" data-v-07fae315${_scopeId2}>${ssrInterpolate(index + 1)}. ${ssrInterpolate(item.label)}</span>`);
                  ...
                  return [
                    createVNode("span", { class: "truncate text-blackcolor text-left dark:text-white" }, toDisplayString(index + 1) + ". " + toDisplayString(item.label), 1),
                    createVNode(_component_UIcon, {
                      name: "i-heroicons-chevron-down-20-solid",
                      class: ["w-5 h-5 transition-transform duration-200", [open ? "rotate-180" : ""]]
                    }, null, 8, ["class"])
        ...
        item: withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="px-5 py-0 text-[#5A5B5B] dark:text-white text-lg" data-v-07fae315${_scopeId}><p class="content" data-v-07fae315${_scopeId}>${item.content ?? ""}</p></div>`);
          } else {
            return [
              createVNode("div", { class: "px-5 py-0 text-[#5A5B5B] dark:text-white text-lg" }, [
                createVNode("p", {
                  class: "content",
...
const __nuxt_component_6 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-07fae315"]]);
