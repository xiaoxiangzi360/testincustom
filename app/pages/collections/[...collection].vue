    ...
    <div class="bg-white">
        <div class="max-row py-8">
            ...
            <div class="relative h-[180px] sm:h-[300px] overflow-hidden">
                ...
                <div class="relative z-10 container mx-auto px-4 sm:px-6 h-full flex flex-col justify-center items-center sm:items-start text-center sm:text-left"
                    style="text-shadow: 0px 2px 4px rgba(34,34,34,0.6);">
                    <h1 class="text-2xl sm:text-5xl font-bold text-white mb-2 sm:mb-4">
                    ...
                    <div v-show="products.length > 0 && !loading"
                        ...
                        <NuxtLink :to="`/product/${product.id}/${product.erpProduct.productEnglishName}`"
                            ...
                            <div class="p-3 sm:p-4">
                                <h3 class="text-xs sm:text-sm mb-1 sm:mb-2 text-customblack mt-2 sm:mt-3 line-clamp-2 font-normal"
