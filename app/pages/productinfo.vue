        ...
        <div v-else class="max-row">
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
                    ...
                    <div class="md:col-span-5">
                        <div class="sticky top-[124px]">
                            ...
                            <Swiper v-if="productinfo.erpProduct.photoList.length > 0" :modules="[Navigation]"
                                :navigation="{
                                ...
                                }" @swiper="onSwiper" @slideChange="onSlideChange" :observer="true"
                                :observeParents="true" :watchSlidesProgress="true">
                    ...
                    <div class="md:col-span-7">
                        ...
                        <div
                            class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0 mb-4 mt-7">
                                ...
                                <div class="flex justify-between items-center cursor-pointer"
                                    ...
                                    <h2 class="font-bold text-lg flex items-center mb-0">
                                        ...
                                        <Tooltip color="white" :overlayInnerStyle="{ color: '#333' }"
                                            placement="topLeft" v-if="property.desc" :title="property.desc"
                                        ...
                                        <div class="flex-1 space-y-4">
                                            <div class="text-base text-gray-800">
                                                    ...
                                                    <div class="mt-4"
                                                        ...
                                                        <div class="flex items-center space-x-4 mt-2">
                                                            ...
                                                            <input type="number" v-model="needinput.inputvalue[pindex]"
                                                                ...
                                                                class="rounded p-1 text-sm w-28" :min="0" :max="100"
                                                                step="1" />
                                                        </div>
                                                    </div>
                                                ...
                                                <div v-if="property.noneedinputlist.length > 0"
                                                    ...
                                                    <Select :value="property.selectedproperty?.propertyDetailId"
                                                        style="width: 200px" :options="property.noneedinputlist"
                                                        :field-names="{ label: 'detailName', value: 'propertyDetailId' }"
                                                        placeholder="Please select attributes" show-search
                                                        :filter-option="customFilter"
                                                        @change="val => onChange(val, property, index)"
                                    ...
                                    <div class="flex-1 space-y-4">
                                        <p class="font-semibold text-sm">
                                            <span v-for="(item, index) in productinfo.printPropertyList">
                                                {{ item.value }}{{ index < productinfo.printPropertyList.length ? ','
                                                    : '' }}</span>
                                        </p>
                                        <div
                                            class="text-primary border-b-2 w-fit border-primary py-1 font-semibold cursor-pointer">
                                            Design
                                            Now</div>
                                    </div>
                                    <div class="w-full md:w-40 shrink-0 self-center">
                                        <img v-show="designimage" :src="designimage" alt="Dimension guide"
                        ...
                        <div class="border-b border-b-[#C8C8C8]">
                            <div class="w-full mx-auto bg-white py-6 sm:py-8 rounded-md">
                                    ...
                                    <div class="flex items-center rounded px-2">
                                        <div class="border flex items-center bg-[#F8F8F8] rounded">
                                            <button @click="decrement"
                                                class="text-gray-500 px-2 hover:text-black">−</button>
                                ...
                                <div
                                    class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-6 sm:mt-8">
                                ...
                                <div class="flex flex-col sm:flex-row gap-4 mt-6 sm:mt-8">
                                    <UButton
                                        ...
                                        :loading="cartloding" @click="addtocart" color="primary" variant="solid"
                                        size="xl">
                                        Add to Cart
                                    </UButton>
                                    <UButton
                                        class="w-full sm:flex-1 flex items-center justify-center rounded-md text-white font-normal"
                                        color="primary" variant="solid" size="xl" :loading="orderloding"
                                        @click="createorder">
                                        Order Now
                                    </UButton>
                                </div>
            ...
            <div class="bg-[#F8F8F8]">
                <div class="mx-auto mt-16">
                        ...
                        <div class="flex justify-start">
                            <div class="w-auto" v-if="productinfo.erpProduct.remarks">
                                <div class="inline-block p-4 rounded-xl rounded-b-none cursor-pointer text-center text-sm sm:text-base"
                                    :class="{ 'border-b-2 border-black font-semibold': tabindex === 1 }"
                                    @click="changetab(1)">
                                    Basic Information
                                </div>
                            </div>
                            <div class="w-auto" v-if="productinfo.printPropertyList.length > 0">
                                <div class="inline-block p-4 rounded-xl rounded-b-none cursor-pointer text-center text-sm sm:text-base"
                                    :class="{ 'border-b-2 border-black font-semibold': tabindex === 2 }"
                                    @click="changetab(2)">
                                    Print Information
                                </div>
                            </div>
                    ...
                    <!-- Content Area -->
                    <div v-show="tabindex == 1 && productinfo.erpProduct.remarks"
                        class="mx-auto max-row p-6 rounded p-2">
